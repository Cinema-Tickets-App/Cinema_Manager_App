...
open class ADTMoviesByCategory(private val mList: List<MovieInfo>, private val context: Context?) :
    ...
    override fun onBindViewHolder(holder: ViewHold, position: Int) {
        var CL_MovieInfoContainer =
            holder.itemView.findViewById<ConstraintLayout>(R.id.CL_MovieInfoContainer);
